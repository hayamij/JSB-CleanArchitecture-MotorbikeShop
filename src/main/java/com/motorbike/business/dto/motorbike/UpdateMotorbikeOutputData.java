...
public class UpdateMotorbikeOutputData {
    ...
    private UpdateMotorbikeOutputData(boolean success, String errorCode, String errorMessage,
    ...
    public static UpdateMotorbikeOutputData forSuccess(Long maSanPham, String tenSanPham,
                                                      String hangXe, String dongXe, String mauSac,
                                                      int namSanXuat, int dungTich, BigDecimal gia,
                                                      LocalDateTime ngayCapNhat) {
        return new UpdateMotorbikeOutputData(true, null, null, maSanPham, tenSanPham,
                                            hangXe, dongXe, mauSac, namSanXuat, dungTich, gia, ngayCapNhat);
    }
    
    public static UpdateMotorbikeOutputData forError(String errorCode, String errorMessage) {
        return new UpdateMotorbikeOutputData(false, errorCode, errorMessage,
